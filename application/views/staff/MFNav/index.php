...
<script>
  $(document).ready(function () {
    $("#data-table").DataTable({
      "ajax":"<?=base_url('staff/Staff/get_mutual_fund_nav')?>",
      "order":[],
      "ordering":false,
...
<script>
    $(document).on("click","#save-record-new",function(){
        ...
        if(naps_scheme_name!="")
        {
            ...
            $.ajax({
            url: baseUrl + "staff/Staff/insert_mutual_fund_nav",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on("click","#record-edit-btn",function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/edit_mutual_fund_nav",
        type: "POST",
        data:form_data,
        contentType: false,
        processData: false,
    ...
    $(document).on("click","#update-record-btn",function(){
       ...
       var baseUrl = "<?=base_url()?>";
        ...
        if(naps_scheme_name!="")
        {
            $("#nps-scheme-name").removeClass("is-invalid");
            $.ajax({
            url: baseUrl + "staff/Staff/update_mutual_fund_nav",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on('change','#excel-input-file',function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/upload_excel_to_mutual_fund_nav",
        type: "POST",
        data: form_data,
        contentType: false,
        processData: false,
