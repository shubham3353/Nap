...
<script>
  $(document).ready(function () {
    $("#data-table").DataTable({
      "ajax":"<?=base_url('staff/Staff/get_all_commodity')?>",
      "order":[],
      "ordering":false,
...
<script>
    $(document).on("click","#save-record-new",function(){
        ...
        $.ajax({
            url: baseUrl + "staff/Staff/insert_commodity",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on("click","#record-edit-btn",function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/edit_commodity",
        type: "POST",
        data:form_data,
        contentType: false,
        processData: false,
...
<script>
    $(document).on("click","#update-record-btn",function(){
       ...
       var baseUrl = "<?=base_url()?>";
        ...
        $.ajax({
            url: baseUrl + "staff/Staff/update_commodity",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on('change','#excel-input-file',function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/upload_excel_to_commodity",
        type: "POST",
        data: form_data,
        contentType: false,
        processData: false,
