        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">NEW PENSION SYSTEM NAV</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">NEW PENSION SYSTEM NAV</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <form id="insert-form">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nps-scheme-name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="today_nav">
                  </div>
                  <div class="form-group">
...
<script>
  $(document).ready(function () {
    $("#data-table").DataTable({
      "ajax":"<?=base_url('staff/Staff/get_all_nps_scheme')?>",
      "order":[],
      "ordering":false,
...
<script>
    $(document).on("click","#save-record-new",function(){
        ...
        var naps_scheme_name = $("#nps-scheme-name").val();
        ...
        if(naps_scheme_name!="")
        {
            ...
            $.ajax({
            url: baseUrl + "staff/Staff/insert_nps_scheme",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
        ...
        }else if(naps_scheme_name=="")
        {
           $("#nps-scheme-name").addClass("is-invalid");
           $("#nps-scheme-name").parent().css("margin-bottom","0");
           $("#nps-scheme-name-err").text("This feild is required.*");
        }
    });
</script>
...
<script>
    $(document).on("click","#record-edit-btn",function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/edit_nps_scheme",
        type: "POST",
        data:form_data,
        contentType: false,
        processData: false,
    ...
    $(document).on("click","#update-record-btn",function(){
       ...
       var baseUrl = "<?=base_url()?>";
        ...
        if(naps_scheme_name!="")
        {
            $("#nps-scheme-name").removeClass("is-invalid");
            $.ajax({
            url: baseUrl + "staff/Staff/update_nps_scheme",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on('change','#excel-input-file',function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/upload_excel_to_nps_scheme",
        type: "POST",
        data: form_data,
        contentType: false,
        processData: false,
