        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">INDEX TABLE</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">INDEX TABLE</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
  $(document).ready(function () {
    $("#data-table").DataTable({
      "ajax":"<?=base_url('staff/Staff/get_all_index')?>",
      "order":[],
      "ordering":false,
...
<script>
    $(document).on("click","#save-record-new",function(){
        ...
        form_data.append('index_name',data1);
        form_data.append('today_value',data2);
        
        $.ajax({
            url: baseUrl + "staff/Staff/insert_index",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on("click","#record-edit-btn",function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/edit_index",
        type: "POST",
        data:form_data,
        contentType: false,
        processData: false,
        ...
        var responseData = response['responseData'];
          if ((responseData != null)) 
           {
             $("#feild-1").val(responseData['index_name']);
             $("#feild-2").val(responseData['today_value']);
...
<script>
    $(document).on("click","#update-record-btn",function(){
       ...
       var baseUrl = "<?=base_url()?>";
        ...
        $.ajax({
            url: baseUrl + "staff/Staff/update_index",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on('change','#excel-input-file',function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/upload_excel_to_index",
        type: "POST",
        data: form_data,
        contentType: false,
        processData: false,
