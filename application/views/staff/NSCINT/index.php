        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">NATIONAL SAVING CERTIFICATE INT</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">NATIONAL SAVING CERTIFICATE INT</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
  $(document).ready(function () {
    $("#data-table").DataTable({
      "ajax":"<?=base_url('staff/Staff/get_all_NATIONAL_SAVING_CERTIFICATE_INT')?>",
      "order":[],
      "ordering":false,
...
<script>
    $(document).on("click","#save-record-new",function(){
        ...
        $.ajax({
            url: baseUrl + "staff/Staff/insert_NATIONAL_SAVING_CERTIFICATE_INT",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on("click","#record-edit-btn",function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/edit_NATIONAL_SAVING_CERTIFICATE_INT",
        type: "POST",
        data:form_data,
        contentType: false,
        processData: false,
...
<script>
    $(document).on("click","#update-record-btn",function(){
       ...
       var baseUrl = "<?=base_url()?>";
        ...
        $.ajax({
            url: baseUrl + "staff/Staff/update_NATIONAL_SAVING_CERTIFICATE_INT",
            type: "POST",
            data: form_data,
            contentType: false,
            processData: false,
...
<script>
    $(document).on('change','#excel-input-file',function(){
       ...
       $.ajax({
        url: baseUrl + "staff/Staff/upload_excel_to_NATIONAL_SAVING_CERTIFICATE_INT",
        type: "POST",
        data: form_data,
        contentType: false,
        processData: false,
...
<script>
    $(document).on("click","#record-delete-btn",function(){
       ...
       var recordid = $(this).attr("key");
        ...
        function(){
            var form_data = new FormData();
            var table = "national_saving_certificate_int";
